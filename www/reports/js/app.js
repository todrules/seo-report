angular.module('app', ['ngMaterial', 'ui.router', 'app.controllers', 'app.directives', 'app.services', 'ngAnimate', 'ngAria', 'ngMessages'])
	...
	.config(['$stateProvider', '$urlRouterProvider', '$logProvider', function($stateProvider, $urlRouterProvider) {
		$stateProvider
			...
			.state('app', {
				url: '/app',
				templateUrl: 'reports/templates/menu.html',
				controller: 'AppCtrl'
			})
			...
			.state('charts', {
				...
				views: {
					'menu': {
						templateUrl: 'reports/templates/charts.html'
					}
				}
			})
			...
			.state('content', {
				...
				views: {
					'menu': {
						templateUrl: 'reports/templates/content.html'
					}
				}
			})
			.state('forms', {
			...
			.state('list', {
				...
				views: {
					'menu': {
						templateUrl: 'reports/templates/list.html',
						controller: 'listCtrl'
					}
				}
			})
			...
			.state('table', {
				...
				views: {
					'menu': {
						templateUrl: 'reports/templates/table.html',
			...
			.state('dashboard', {
				...
				views: {
					'menu': {
						templateUrl: 'reports/templates/dashboard.html',
